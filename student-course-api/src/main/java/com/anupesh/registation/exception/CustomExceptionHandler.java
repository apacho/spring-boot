package com.anupesh.registation.exception;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleStudentCourseNotFoundException(StudentCourseIllegalStateException ex,
			WebRequest request) {
		List<String> details = new ArrayList<>();
		details.add(ex.getLocalizedMessage());
